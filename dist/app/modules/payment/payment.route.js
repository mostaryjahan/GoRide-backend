...
router.post("/init-ride-payment/:rideId", payment_controller_1.PaymentController.initRidePayment);
...
router.post("/invoice/:paymentId", (0, checkAuth_1.checkAuth)(...Object.values(user_interface_1.Role)), payment_controller_1.PaymentController.getInvoiceDownloadUrl);
