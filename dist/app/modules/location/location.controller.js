...
const searchLocation = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filteredLocations = mockLocations.filter(location => location.address_line1.toLowerCase().includes((query_text === null || query_text === void 0 ? void 0 : query_text.toLowerCase()) || '') ||
        location.address_line2.toLowerCase().includes((query_text === null || query_text === void 0 ? void 0 : query_text.toLowerCase()) || ''));
